...
function Feature() {
    return (
        <div className="text-white    pb-10 bg-[url(https://cdn.prod.website-files.com/6584ee98993ef2a2ba17f296/65850001dcdc7fa1686a8490_Noise_Black.webp)] w-full h-full  ">
            ...
            <div>
                {/* item 1 */}
                <div className="group flex flex-row m-auto  w-10/12 py-3">
                    ...
                    <div className="flex flex-row gap-6  transition-transform duration-300 group-hover:translate-x-9 group-hover:scale-104">
                        ...
                        <p className="text-8xl uppercase  text-gray-500 font-bold group-hover:text-white max-md:text-4xl "> crime Alter</p>
                    </div>
                ...
                <div className="group flex flex-row m-auto  w-10/12  py-3">
                    ...
                    <div className="flex flex-row gap-6  transition-transform duration-300 group-hover:translate-x-9 group-hover:scale-104">
                        ...
                        <p className="text-8xl uppercase  text-gray-500 font-bold group-hover:text-white max-md:text-4xl "> Accident & Traffic</p>
                    </div>
                ...
                <div className="group flex flex-row m-auto  w-10/12 py-3 ">
                    ...
                    <div className="flex flex-row gap-6  transition-transform duration-300 group-hover:translate-x-9 group-hover:scale-104">
                        ...
                        <p className="text-8xl uppercase  text-gray-500 font-bold group-hover:text-white max-md:text-4xl ">Weather Alter</p>
                    </div>
                ...
                <div className="group flex flex-row m-auto  w-10/12  py-3">
                    ...
                    <div className="flex flex-row gap-6  transition-transform duration-300 group-hover:translate-x-9 group-hover:scale-104">
                        ...
                        <p className="text-8xl uppercase  text-gray-500 font-bold group-hover:text-white max-md:text-4xl "> Health Emergencies</p>
                    </div>

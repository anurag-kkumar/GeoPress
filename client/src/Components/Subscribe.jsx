  ...
  return (
    <div className="text-white bg-[url('https://cdn.prod.website-files.com/6584ee98993ef2a2ba17f296/65850001dcdc7fa1686a8490_Noise_Black.webp')] w-full h-full">
      ...
      <div className="group bg-blue-400 w-full min-h-[400px] flex flex-col md:flex-row items-center justify-between px-6 md:px-16 py-10">
        ...
        {/* Right Section */}
        <div className="w-full md:w-1/2 flex flex-col text-black">
          <p className="py-2 font-medium text-center md:text-left">✨ Subscribe</p>

          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-center md:text-left leading-tight">
            Get the latest
          </h1>
          ...
          <button className="bg-black text-[#E0FF00] font-semibold py-2 px-6 rounded-lg hover:bg-gray-800 transition w-full md:w-auto">
            Subscribe Now
          </button>
        </div>
      </div>
      ...
      <div className="overflow-hidden whitespace-nowrap bg-black pt-20">
        <div className="animate-marquee inline-block">
          <span className="text-[#D4F600] text-stroke font-black text-5xl sm:text-7xl md:text-8xl lg:text-9xl">
            WELCOME TO CAREER COMPASS
          </span>
          <span className="text-transparent text-stroke font-black text-5xl sm:text-7xl md:text-8xl lg:text-9xl mx-10">
            LEARN BUILD GROW
          </span>
        </div>
      </div>
      ...
      <div className="overflow-hidden whitespace-nowrap bg-black pb-7">
        <div className="animate-marqueeS inline-block">
          <span className="text-transparent text-stroke font-black text-5xl sm:text-7xl md:text-8xl lg:text-9xl px-5">
            WELCOME TO CAREER COMPASS
          </span>
          <span className="text-[#D4F600] text-stroke font-black text-5xl sm:text-7xl md:text-8xl lg:text-9xl">
            LEARN BUILD GROW
